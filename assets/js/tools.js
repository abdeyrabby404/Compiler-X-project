...
document.getElementById("btn-process-lr").addEventListener("click", () => {
    ...
    document.getElementById("lr-output").innerHTML = `<pre class="text-white overflow-auto h-68">${result}</pre>`;
...
document.getElementById("btn-process-lf").addEventListener("click", () => {
    ...
    document.getElementById("lf-output").innerHTML = `<pre class="text-white overflow-auto h-68">${result}</pre>`;
